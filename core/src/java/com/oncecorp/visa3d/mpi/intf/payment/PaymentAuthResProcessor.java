...
/**
 * Description: Implement processor class for Message: PaymentAuthRes.
 * Currently there is no activities involved.
 * 
 * @version 0.1 July 24, 2002
 * @author	Alan Zhang
 */
public class PaymentAuthResProcessor implements MessageProcessor {
	/**
	 * PaymentAuthResProcessor type
	 */
	public final static String PROCESSOR_TYPE = "PaymentAuthRes";

	/**
	 * Local Log4J logger
	 */
	public Logger logger =
		MPILogger.getLogger(PaymentAuthResProcessor.class.getName());
