...
/**
 * Description: Base64 Codec (See RFC 2045 for detailed Base64 encoding specification).
 * Credit should be given to Robert Harder.
 * 
 * Encoding sample:
 * <pre>
 * 		String toEncodingString;
 * 
 * 			........
 * 
 * 		String encodedString = Base64Codec.encodeToString( toEncodingString );
 * </pre>
 * 
 * 
 * Decoding sample:
 ...
 * 			......
 * 
 * 		String decodedString = Base64Codec.decodeString( encodedString );
 * </pre>
 * 
...
public class Base64Codec {
	...
	public static String encodeObject(java.io.Serializable serializableObject) {
		...
		try {
			...
			b64os = new Base64Codec.OutputStream(baos, Base64Codec.ENCODE);
	...
	/**
	 * A {@link Base64Codec#InputStream} will read data from another
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64Codec#InputStream} in DECODE mode.
		 *
		 * @param in the {@link java.io.InputStream} from which to read data.
		 */
		public InputStream(java.io.InputStream in) {
			this(in, Base64Codec.DECODE);
		} // end constructor

		/**
		 * Constructs a {@link Base64Codec#InputStream} in
		 * either ENCODE or DECODE mode.
		 *
		 * @param in the {@link java.io.InputStream} from which to read data.
		 * @param encode Conversion direction
		 * @see Base64Codec#ENCODE
		 * @see Base64Codec#DECODE
		 */
	...
	/**
	 * A {@link Base64Codec#OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64Codec#OutputStream} in ENCODE mode.
		 *
		 * @param out the {@link java.io.OutputStream} to which data will be written.
		 */
		public OutputStream(java.io.OutputStream out) {
			this(out, Base64Codec.ENCODE);
		} // end constructor

		/**
		 * Constructs a {@link Base64Codec#OutputStream} in
		 * either ENCODE or DECODE mode.
		 *
		 * @param out the {@link java.io.OutputStream} to which data will be written.
		 * @param encode Conversion direction
		...
		public void write(int theByte) throws java.io.IOException {
			if (encode) {
				...
				if (position >= bufferLength) // Enough to encode.
					{
					out.write(Base64Codec.encode3to4(buffer, bufferLength));
			...
			// Else, Decoding
				...
				if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					if (position >= bufferLength) // Enough to output.
						{
						out.write(Base64Codec.decode4to3(buffer));
						position = 0;
					} // end if: enough to output
		...
		public void flush() throws java.io.IOException {
			...
			if (position > 0) {
				if (encode) {
					out.write(Base64Codec.encode3to4(buffer, position));
				} // end if: encoding
				else {
