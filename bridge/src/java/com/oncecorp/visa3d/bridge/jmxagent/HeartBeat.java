...
import com.oncecorp.visa3d.bridge.monitoring.HeartBeatMBean;
...
public class HeartBeat implements HeartBeatMBean {
	...
	public void addHeartBeatListener(String listenerName, Object connectorType, Object listenerAddress, Properties props) {
		...
		try {
			RemoteMBeanServer conn = BridgeHeartBeatConnectorFactory.getFactory().getConnector(connectorType, listenerAddress, props);
