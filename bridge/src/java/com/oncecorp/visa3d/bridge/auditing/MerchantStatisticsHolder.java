 ...
 * Description:  This class holdes all of the merchant statistics counters.
 ...
 * @version 1.0
 */
public class MerchantStatisticsHolder extends StatisticsHolder {

    /**
     * The constructor of the class.
     * @param name The holder name.
     */
    public MerchantStatisticsHolder (String name) {
        super(name);
    }
    ...
    public void count( Properties props )
    {
        ...
        if ( merchantId != null )
        {
            if (!containsSubCounter(merchantId)) {
                add( new MerchantCounter(merchantId) );
            }
            getSubCounter(merchantId).count(props);
        }
    }
}
